...
export default function Hero() {
  return (
    <section className="flex flex-col gap-6">
      <Pill className="animate-fade-in animation-delay-300 will-change-opacity">풀타임, 파트타임</Pill>
      ...
      <Link className="hidden sm:inline underline underline-offset-4 text-lg font-black" href="#contact">
        개발자가 필요하신가요?
      </Link>
      <div className="mt-12 hidden sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in-500 will-change-opacity">
        <HeroStat title="평균 월 120만원" description="임금을 해당 국가를 기준으로 책정합니다." />
        <HeroStat
          title="최대 3회 인터뷰"
